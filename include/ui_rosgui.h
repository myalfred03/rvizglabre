...
public:
    ...
    void setupUi(QMainWindow *ROSGUI)
    {
        ...
        ROSGUI->resize(1038, 710);
        ROSGUI->setMaximumSize(QSize(1380, 720));
        ...
        mdiArea->setMaximumSize(QSize(800, 520));
        ...
        menuBar->setGeometry(QRect(0, 0, 1038, 18));
